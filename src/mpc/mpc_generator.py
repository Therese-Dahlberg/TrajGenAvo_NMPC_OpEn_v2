# This code creates the nmpc formulationa and builds the autogenerated rust/opengen... code to solve the problem.
...
from path_planner.obstacle_handler import ObstacleHandler as oh
...
class MpcModule:
    ...
    def cost_inside_static_object(self, x_all, y_all, q, individual_costs=False):
        ...
        for t in range(0, self.solver_param.base.n_hor):
            ...
            if not individual_costs:
                ...
                crash_in_trajectory.append(crash*q)
        # print("static ", crash_in_trajectory)
        return crash_in_trajectory
    ...
    def build(self):
        ...
        #Test function with the boundig circle
        cost+=self.cost_cargo_inside_static_circle(all_x_master[1:], all_y_master[1:], all_x_slave[1:], all_y_slave[1:], [static_obs[0], unexpected_obs[0]], self.q_obs_c)
